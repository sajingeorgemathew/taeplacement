...
import type { StudentNote } from "@/lib/students/queries";
...
/**
 * Internal comments for one student.
 *
 * The panel slides in over the student page, so staff never lose the record
 * they are reading or their scroll position.
 */
export default function NotesPanel({
  ...
  // Clear the box once a note has been posted successfully.
  useEffect(() => {
      ...
      {open ? (
        <div className="fixed inset-0 z-50">
          ...
          <div
            role="dialog"
            aria-modal="true"
            aria-label={`Comments for ${studentName}`}
